...
from src.model.processor import LLAVA_NEXT, QWEN2_VL, QWEN2_5_VL, \
    QWEN2_VL_TOKENSELECTION, QWEN2_5_VL_TOKENSELECTION, PHI3V, process_vlm_inputs_fns ,QWEN3_5
                ...
                if type(raw_images) == dict:
                    ...
                    for image_idx in range(num_images):
                        ...
                        if image is not None and (self.data_args.image_decay_factor is not None and image_resolution is None):
                            ...
                            assert self.model_args.model_backbone in [QWEN2_VL, QWEN2_5_VL, QWEN2_VL_TOKENSELECTION, QWEN2_5_VL_TOKENSELECTION, QWEN3_5], "image_decay_factor is only supported for Qwen models"
