...
export WANDB_PROJECT=vlm2vec-debug
export WANDB_RUN_GROUP=Qwen3.5-2b-hatefulmemes
export EXP_NAME=Qwen3.5-2b-hatefulmemes
...
cmd="python3 train.py \
  ...
  --dataset_config /workspace/VLM2Vec/experiments/public/train/train_image_debug_minimal.yaml \
  --run_name $EXP_NAME \
  --output_dir $EXP_DIR \
  --grad_cache True \
